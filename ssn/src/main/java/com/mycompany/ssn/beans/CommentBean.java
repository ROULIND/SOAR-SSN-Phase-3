...
/**
    ...
    public void makeComment(XUserOLD user, XPostOLD post) throws IllegalArgumentException {
        ...
        if (this.currentCommentText == null || this.currentCommentText.length() > 256 || this.currentCommentText.length() == 0) {
            ...
            XCommentOLD comment = new XCommentOLD(post.getId(), user.getId(), this.currentCommentText);
